...
with tab_audit:
    ...
    st.caption("⚖️ **Отказ от ответственности:** Данный сервис работает на базе искусственного интеллекта и предназначен исключительно для информационных целей. Анализ не является квалифицированной юридической консультацией. ИИ может допускать ошибки. Перед подписанием документа обязательно проконсультируйтесь с юристом.")
    st.divider()
