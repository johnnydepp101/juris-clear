            ...
            if show_full:
                ...
                st.markdown(f"""
                    <img src="dummy" onerror="
                        if (!window.lemonLoaded) {{
                            var s = document.createElement('script');
                            s.src = 'https://app.lemonsqueezy.com/js/lemon.js';
                            document.head.appendChild(s);
                            window.lemonLoaded = true;
                        }}
                    " style="display:none;">
                    <a href='{buy_link}' class='lemonsqueezy-button' onclick="if(window.createLemonSqueezy) window.createLemonSqueezy();" style='text-decoration: none;'>
