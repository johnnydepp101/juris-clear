    ...
    def render_audit_content():
        ...
        if "analysis_result" in st.session_state:
            ...
            if show_full:
                ...
                st.markdown(f"""
                    <div onclick="window.top.location.href='{buy_link}';" style='background: linear-gradient(135deg, #FF9933 0%, #FF6600 100%); color: white; padding: 14px; border-radius: 12px; text-align: center; font-weight: 700; font-size: 16px; width: 100%; box-shadow: 0 4px 15px rgba(255, 102, 0, 0.4); border: 1px solid rgba(255, 255, 255, 0.2); cursor: pointer; transition: transform 0.2s;'>
